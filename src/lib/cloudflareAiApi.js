...
const buildTextPromptFromTask = (task, input) => {
  ...
  if (safeTask === 'gamificacao_desafio') {
    return [
      ...
      'A recomendacao do livro deve evoluir com o nivel do aluno.',
      'Para niveis baixos, priorize livros curtos, mais acessiveis, com linguagem simples e boa porta de entrada para criar constancia.',
      'Para niveis intermediarios, aumente aos poucos a densidade, o vocabulario e a complexidade do tema.',
      'Para niveis altos, proponha livros medianos ou mais desafiadores, com mais interpretacao e profundidade.',
      ...
      'Ao escolher o livro, leve em conta a faixa indicada, o porte estimado e a prioridade_nivel enviados no catalogo.',
      'Evite recomendar livro muito denso para aluno de nivel baixo.',
